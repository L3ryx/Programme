...
// Objectifs hebdomadaires — liste fixe par semaine
export const objectifsParSemaine = [
  // Semaine 1
  [
    { id: "s1_1", titre: "Prendre son traitement chaque matin", categorie: "sante" },
    { id: "s1_2", titre: "Dormir avant minuit au moins 5 jours", categorie: "sante" },
    { id: "s1_3", titre: "Aucun contact avec de la cocaïne", categorie: "sante" },
    { id: "s1_4", titre: "Appeler un professionnel de santé", categorie: "sante" },
    { id: "s1_5", titre: "Sortir de chez soi au moins 1 fois par jour", categorie: "vie" },
    { id: "s1_6", titre: "Faire du sport au moins 2 fois", categorie: "vie" },
    { id: "s1_7", titre: "Aucun message accusateur envoyé", categorie: "relation" },
  ],
  // Semaine 2
  [
    { id: "s2_1", titre: "Prendre son traitement chaque matin", categorie: "sante" },
    { id: "s2_2", titre: "Dormir avant minuit au moins 5 jours", categorie: "sante" },
    { id: "s2_3", titre: "Aucun contact avec de la cocaïne", categorie: "sante" },
    { id: "s2_4", titre: "Tenir un carnet de suivi d'humeur (3 jours min.)", categorie: "sante" },
    { id: "s2_5", titre: "Faire du sport au moins 3 fois", categorie: "vie" },
    { id: "s2_6", titre: "Contacter un ami (Valentin ou autre)", categorie: "vie" },
    { id: "s2_7", titre: "Aucune surveillance (localisation, réseaux)", categorie: "relation" },
  ],
  // Semaine 3
  [
    { id: "s3_1", titre: "Prendre son traitement chaque matin", categorie: "sante" },
    { id: "s3_2", titre: "Aucun contact avec de la cocaïne", categorie: "sante" },
    { id: "s3_3", titre: "RDV médical pris ou confirmé", categorie: "sante" },
    { id: "s3_4", titre: "Faire du sport au moins 3 fois", categorie: "vie" },
    { id: "s3_5", titre: "Travailler sur un projet créatif (musique, autre)", categorie: "vie" },
    { id: "s3_6", titre: "Aucun message envoyé en état de crise", categorie: "relation" },
    { id: "s3_7", titre: "Écrire dans son carnet plutôt qu'envoyer un message impulsif", categorie: "relation" },
  ],
  // Semaine 4
  [
    { id: "s4_1", titre: "Prendre son traitement chaque matin", categorie: "sante" },
    { id: "s4_2", titre: "Aucun contact avec de la cocaïne", categorie: "sante" },
    { id: "s4_3", titre: "Tenir un carnet de suivi d'humeur (5 jours min.)", categorie: "sante" },
    { id: "s4_4", titre: "Faire du sport au moins 3 fois", categorie: "vie" },
    { id: "s4_5", titre: "Reprendre une activité professionnelle (même partielle)", categorie: "vie" },
    { id: "s4_6", titre: "Aucune demande d'argent à Camille", categorie: "relation" },
    { id: "s4_7", titre: "Parler en 'je' lors d'une discussion difficile", categorie: "relation" },
  ],
];

// Choses à faire et ne pas faire chaque semaine (liste générale)
export const todoHebdo = {
  faire: [
    "Prendre ses médicaments chaque matin sans exception",
    "Faire du sport au moins 3 fois dans la semaine",
    "Sortir de chez soi chaque jour, même brièvement",
    "Écrire dans son carnet d'humeur le soir",
    "Contacter au moins un ami cette semaine",
    "Aller dormir avant minuit",
    "Avancer sur un projet personnel (musique, travail, créatif)",
    "Appeler son médecin ou thérapeute si quelque chose ne va pas",
  ],
  nepasiFaire: [
    "Envoyer un message quand on est en état de crise ou de colère",
    "Vérifier la localisation ou les réseaux de Camille",
    "Consommer de la cocaïne, même 'juste une fois'",
    "Rester enfermé plus d'une journée sans sortir",
    "Envoyer des messages après minuit",
    "Demander de l'argent à Camille",
    "Stopper le traitement de sa propre initiative",
    "Régler ses comptes par message — attendre une vraie conversation",
  ],
};
