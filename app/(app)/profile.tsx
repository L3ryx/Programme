/**
 * profile.tsx — Écran de profil (Appwrite)
 *
...
import { signOut, updateProfile } from '../../src/lib/appwrite';
...
export default function ProfileScreen() {
  ...
  async function saveProfile() {
    ...
    setSaving(true);
    const updated = await updateProfile(profile.$id, { display_name: displayName.trim() });
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 40 }}>
      ...
      <View style={styles.section}>
        ...
        <InfoRow icon="shield-checkmark" text="Double authentification email activée" />
      </View>
...
const styles = StyleSheet.create({
  ...
  header: { paddingTop: 56, paddingBottom: 16, paddingHorizontal: 20, backgroundColor: CARD, borderBottomWidth: 1, borderBottomColor: BORDER },
  headerTitle: { color: '#fff', fontWeight: '800', fontSize: 24 },
  avatarSection: { alignItems: 'center', padding: 32 },
  avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: ROSE, alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
  ...
  nameInput: { backgroundColor: CARD, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6, color: '#fff', fontSize: 16, borderWidth: 1, borderColor: BORDER, minWidth: 150 },
  saveBtn: { backgroundColor: ROSE, borderRadius: 8, padding: 8, alignItems: 'center', justifyContent: 'center' },
  section: { marginHorizontal: 16, marginBottom: 16 },
  sectionTitle: { color: '#fff', fontWeight: '700', fontSize: 16, marginBottom: 12 },
  partnerCard: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: CARD, borderRadius: 16, padding: 16, borderWidth: 1, borderColor: BORDER },
  partnerAvatar: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#5b0a2e', alignItems: 'center', justifyContent: 'center' },
  ...
  permanentNote: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 10, paddingHorizontal: 4 },
  permanentNoteText: { color: '#444', fontSize: 12 },
  hint: { color: '#555', fontSize: 14 },
  infoCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, backgroundColor: CARD, borderRadius: 12, padding: 12, borderWidth: 1, borderColor: BORDER, marginBottom: 8 },
  infoText: { color: '#888', fontSize: 13, flex: 1, lineHeight: 18 },
  logoutBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginHorizontal: 16, marginTop: 8, backgroundColor: CARD, borderRadius: 12, padding: 16, borderWidth: 1, borderColor: BORDER },
